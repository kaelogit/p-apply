...
export const winnerStories: WinnerStory[] = [
  // ── SuperPrize & Mega Prize ─────────────────────────────────
  {
    ...
    paragraphs: [
      ...
      'Carol submitted her latest PCH application from her phone before a hospital shift. Within twenty-four hours, a personal email arrived from applypchdigital.com — subject line: "Important message regarding your PCH application." Carol read it three times in the break room before her hands stopped shaking.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Within twenty-four hours of applying, Malik received a personal email from applypchdigital.com confirming his submission was under review. When selected for the SuperPrize, a follow-up message arrived the same week. Malik muted his microphone during a stand-up meeting to read it twice before telling anyone.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Within twenty-four hours of applying, Elena received a personal email from applypchdigital.com. It had landed in spam; her oldest daughter found it while helping Elena set up a new phone and said, "Mom, this looks official." When selected for the SuperPrize, follow-up instructions were clear: respond within forty-eight hours.',
  ...
  // ── Weekly For Life ─────────────────────────────────────────
  {
    ...
    paragraphs: [
      ...
      'He submitted a PCH application during lunch in the program\'s parking lot — phone propped on the steering wheel, form filled out in eleven minutes. Within twenty-four hours, a personal email from applypchdigital.com confirmed his submission. When selected for $5,000 A Week For Life, follow-up verification arrived the same week.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Patricia\'s granddaughter showed her the PCH apply page on a tablet during Thanksgiving. Patricia applied that evening. Within twenty-four hours, a personal email from applypchdigital.com confirmed her submission. When selected for $5,000 A Week For Life at sixty-four, follow-up instructions arrived by mail.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Carlos applied that night from the VA computer lab. Within twenty-four hours, a personal email from applypchdigital.com confirmed his submission. When selected for $2,500 A Week For Life, verification required ID, service records, and patience — Carlos had learned patience in harder schools.',
  ...
  // ── Dream Home ──────────────────────────────────────────────
  {
    ...
    paragraphs: [
      ...
      'Mrs. Martinez, Rosa, slept in a rental in Pasadena with her husband and two children, scrolling phone photos of what used to be their kitchen. A neighbor sent her the link to applypchdigital.com. "Enter," the neighbor wrote. "What do you have to lose?"',
      ...
      'Within twenty-four hours of applying, Rosa received a personal email from applypchdigital.com. When selected in the Dream Home drawing, the family received $420,000 — enough to rebuild on the original lot instead of abandoning the neighborhood.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Within twenty-four hours of applying, Michael received a personal email from applypchdigital.com while marking essays on colonial trade routes during term break. When selected for the Dream Home prize, he finished the essay in the stack before opening the winner details — old habits.',
  ...
  // ── Cash Prize ──────────────────────────────────────────────
  {
    ...
    paragraphs: [
      ...
      'Within twenty-four hours of applying, Sarah received a personal email from applypchdigital.com. When selected in a cash prize drawing, her $250,000 award followed after verification — prove you are real, prove you exist, prove the money should go to you.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Within twenty-four hours of applying, Aisha received a personal email from applypchdigital.com. When selected for the cash prize, she opened a spreadsheet and listed every expense the award could cover.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Within twenty-four hours of applying, Naomi received a personal email from applypchdigital.com. When selected for the $100,000 cash prize, she used it for regulatory testing, material batches, and the first shipment to a clinic in Lisbon willing to pilot her designs.',

...
You do not need to do anything right now. If your application moves to the next stage, we will email you from **support@applypch.com** and text you from **+1 (917) 743-0256** with instructions within the next **5 hours**.
...
Hi [First Name], thank you for applying at applypch.com. We received your prize application and it is under review.
...
```
If your application advances, we will contact you by email from support@applypch.com AND by text from this number (+1 917-743-0256) within the next 5 hours with next steps.
...
**Steps:**
1. Send exactly **$800.00 USD** using the method above.  
...
- [ ] Text only from **+1 (917) 743-0256**
- [ ] Send **all** text parts for that step (not just the first one)
